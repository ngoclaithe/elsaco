...
export default function AdminDashboard() {
  ...
  const cards = [
    ...
    { label: 'Revenue', value: formatPrice(stats.totalRevenue), href: '/admin/orders' },
  ];
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        {cards.map((c) => (
          <Link key={c.label} href={c.href} className="bg-white border border-neutral-200 p-6 hover:border-black transition-colors">
